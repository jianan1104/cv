  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        ...
        <Section>
          ...
          {RESUME_DATA.work.map((work) => {
            return (
              <Card key={work.title}>
                <CardHeader>
                  <div className="sm:flex items-center justify-between gap-x-2 text-base">
                    <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                      <a>
                        {work.title}
                      </a>
                    </h3>
                    <span className="inline-flex gap-x-1 text-sm text-gray-500">
                        {work.location} | {work.wtype}
                    </span>
                    
                  </div>
                  <div className="flex justify-between gap-x-2 text-base">
                    <span className=" text-sm leading-none">
                      <a className="hover:underline text-blue-500" href={work.link}>{work.company}</a> | {work.type}
                    </span>
                    <div className="text-sm tabular-nums text-gray-500">
                      {work.start}{work.end ? ' - ' + work.end : null}
                    </div>
                  </div>
        ...
        <Section>
          <h2 className="text-xl font-bold">Framework and Tools</h2>
            ...
            {RESUME_DATA.achievements.map((achievement) => {
              return (
                <AchievementCard
                  ...
                  link={"link" in achievement ? achievement.link.href : undefined}
                />
              );
            })}
          </div>
